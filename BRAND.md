...
If any of these files are missing, STOP and ask the human to provide them. Do not generate placeholders.
...
- If asked for a "new logo" or "rebranding", STOP and ask the human for explicit instructions.
...
Agents must respect all of them when working on Vidurai.
